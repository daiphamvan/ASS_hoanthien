		...
		<div class="container">
			<div class="single">
				<div class="col-md-9 top-in-single">
					...
					<div class="col-md-7 single-top-in">
						<div class="single-para">
							...
							<h5>100 Các Mặt Hàng Trong Kho</h5>
							<div class="available">
								<h6>Tùy chọn :</h6>
								<ul>
									<li>Màu:
				...
				<div class="content-top-in">
                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server" Height="144px" Width="289px" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="MaLoai">
